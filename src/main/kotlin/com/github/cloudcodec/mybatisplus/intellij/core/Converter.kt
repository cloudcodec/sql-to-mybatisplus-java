...
import com.github.cloudcodec.mybatisplus.intellij.core.druid.Parser
...
object Converter {
    ...
    fun convert(sql: String, pkg: String): List<MybatisPlusThing> {
        return convert(Parser.parse(sql), pkg)
    }

    private fun convert(tableInfos: List<TableInfo>, pkg: String): List<MybatisPlusThing> {
